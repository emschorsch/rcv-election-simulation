...
| **Electionware PDFs** (multiple county sites) | **Berks 2023/2025; Chester, Northampton, Mercer, Northumberland 2021/2023/2025; Centre 2025; Lebanon 2021/2025; Indiana 2025** | Reading, West Chester, Bethlehem/Easton, State College, City of Lebanon, Mercer/Sharon/Hermitage, Sunbury/Shamokin, Indiana borough + surrounding municipalities. Snyder and Schuylkill are also confirmed Electionware per OE parser docstrings, but their PDF URLs require interactive-portal scraping (deferred). | ✅ Integrated as `ElectionwarePdfSource` (pdfplumber + regex, no API key needed). `LlmPdfSource` retained as an alternative for novel PDF layouts. Note: Lycoming and Bedford turned out to use *different* PDF vendors. |
